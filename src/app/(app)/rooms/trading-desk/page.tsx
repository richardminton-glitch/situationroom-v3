...
import { useOpsRoom } from '@/components/layout/OpsRoomProvider';
import { C, FONT } from '@/components/bot-room/constants';

/**
 * Trading Desk — autonomous trading terminal (formerly "Bot Room").
 *
 * Phase 3: the inline OpsRoom mount is gone (lives in the global (app)
 * shell). The internal TopBar's OPS toggle is bridged to the shared
 * OpsRoomProvider so clicking it opens the same global slide-over as the
 * TopBar OPS button.
 */
export default function TradingDeskPage() {
  ...
  const { open: opsRoomOpen, toggle: toggleOpsRoom, unreadCount: chatUnread } = useOpsRoom();
