...
interface FundingStatus {
  ...
  costsBreakdown: { apiNinjas: number; hosting: number; domains: number; email: number; ai: number; total: number };
}
  ...
  return (
    <div style={{ fontFamily: 'var(--font-mono)', padding: '24px', maxWidth: '600px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '16px', marginBottom: '20px' }}>
        ...
        {Object.entries({ 'xAI Grok': costsBreakdown.ai, 'API Ninjas': costsBreakdown.apiNinjas, 'Email (Resend)': costsBreakdown.email, 'Hosting': costsBreakdown.hosting, 'Domains': costsBreakdown.domains }).map(([name, cost]) => (
