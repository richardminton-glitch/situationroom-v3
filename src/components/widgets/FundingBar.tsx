...
interface FundingStatus {
  ...
  costsBreakdown: { apiNinjas: number; hosting: number; claude: number };
}
  ...
  return (
    <div style={{ fontFamily: 'var(--font-mono)', padding: '24px', maxWidth: '600px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '16px', marginBottom: '20px' }}>
        ...
        {Object.entries({ 'API Ninjas': costsBreakdown.apiNinjas, 'Hosting': costsBreakdown.hosting, 'Claude AI': costsBreakdown.claude }).map(([name, cost]) => (
