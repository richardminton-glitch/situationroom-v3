...
/**
 * MacroAnalysisPanel — VIP-only Grok-3 deep dive analysis
 *
 * Fetches AI-generated analysis of all macro indicators from the
 * macro dashboard. Cached for 6 hours — VIP users see a refresh
  ...
  if (!canAccess('vip')) {
    return (
      <div style={{ padding: '20px', textAlign: 'center', fontFamily: 'var(--font-mono)', fontSize: '11px', color: 'var(--text-muted)' }}>
        Macro Deep Analysis requires VIP access.
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', gap: '8px' }}>
      ...
      <div style={{ display: 'flex', gap: '6px', alignItems: 'center', flexShrink: 0 }}>
        ...
        >
          {data ? (canRefresh ? 'REFRESH ANALYSIS' : 'VIEW ANALYSIS') : 'ANALYSE MACRO'}
        </button>
        {data && !canRefresh && (
          <span style={{
            fontFamily: 'var(--font-mono)',
